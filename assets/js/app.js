(() => {
  ...
  function ensureDesignTheme() {
    ...
    return new Promise((resolve) => {
      ...
      if(existing){existing.addEventListener('load',()=>resolve(window.BRGY_THEME),{once:true});return;}
