(() => {
  ...
  const GUARD_VERSION = '20260901-guard5';
  ...
  function ensureSafetyCssLast(){ensureStyleLast('link[data-brgy-mobile-menu-fix]','mobile-menu-fix.css','data-brgy-mobile-menu-fix');ensureStyleLast('link[data-brgy-touch-nav-fallback]','touch-nav-fallback.css','data-brgy-touch-nav-fallback');}
